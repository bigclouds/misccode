...
#ip addr add 192.101.6.98/24 dev vxlanbr1

ovs-vsctl add-port vxlanbr1 xnic1 -- set Interface xnic1 type=internal
ip link set xnic1 up
ip addr add  192.101.1.98/24 dev xnic1

ovs-vsctl add-port vxlanbr1 vxlanp0 -- set interface vxlanp0 type=vxlan option:remote_ip=172.20.12.99 option:key=5 option:df_default=false
#ping -I xnic1 192.101.1.99
