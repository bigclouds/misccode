...
brctl addif testbr test1o
brctl addif testbr test2o
...
ip netns exec test2 sysctl -w net.ipv4.ip_local_port_range="500 65535"
...
brctl addif brvm5 vm5testi
brctl addif brvm6 vm6testi
brctl addif brvm7 vm7testi
brctl addif brvm8 vm8testi
brctl addif testbr vm5testo
brctl addif testbr vm6testo
brctl addif testbr vm7testo
brctl addif testbr vm8testo
...
brctl addif brvm5 vnet5
brctl addif brvm6 vnet6
brctl addif brvm7 vnet7
brctl addif brvm8 vnet8
...
ip netns exec test3 sysctl -w net.ipv4.ip_local_port_range="1000 65535"
ip netns exec test4 sysctl -w net.ipv4.ip_local_port_range="1000 65535"
ip netns exec test5 sysctl -w net.ipv4.ip_local_port_range="1000 65535"
ip netns exec test6 sysctl -w net.ipv4.ip_local_port_range="1000 65535"
ip netns exec test7 sysctl -w net.ipv4.ip_local_port_range="1000 65535"
ip netns exec test8 sysctl -w net.ipv4.ip_local_port_range="1000 65535"
